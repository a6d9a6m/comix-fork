...
use crate::arch::memory::{TlbBatchContext, paddr_to_vaddr, vaddr_to_paddr};
use crate::config::PAGE_SIZE;
use crate::memory::address::{Paddr, PageNum, Ppn, UsizeConvert, Vpn, VpnRange};
use crate::memory::frame_allocator::{TrackedFrames, alloc_frame};
...
use crate::user_api::memory::MapFlags;
...
impl MappingArea {
    ...
    pub fn get_ppn(&self, vpn: Vpn) -> Option<crate::memory::address::Ppn> {
    ...
    pub fn clone_with_data(
        ...
        use crate::arch::memory::TlbBatchContext;
        ...
        TlbBatchContext::execute(|batch| {
            ...
            for (vpn, tracked_frames) in &self.frames {
                match tracked_frames {
                    ...
                    //    let new_frame_range = crate::memory::frame_allocator::alloc_contig_frames_aligned(
                    //        num_pages,
                    //        num_pages,
...
//             MapType::Framed => {
//                 // 使用对齐分配
//                 let frame_range = crate::memory::frame_allocator::alloc_contig_frames_aligned(
//                     num_pages,
//                     num_pages,  // 对齐要求 = 页数
