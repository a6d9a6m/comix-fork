...
use crate::{
    arch::interrupts::{are_interrupts_enabled, disable_interrupts, enable_interrupts},
    earlyprintln,
};
...
pub fn test_runner(tests: &[&dyn Fn()]) {
    use crate::{arch::lib::sbi::shutdown, earlyprintln, tests::macros::TEST_FAILED};
...
mod tests {
    ...
    //     // 我们断言这一点来验证宏的行为。
    //     kassert!(crate::arch::interrupts::are_interrupts_enabled());
