...
//!
//! // 2. 创建必要的目录
//! let root = virtual_fs::get_root_dentry()?;
...
// use crate::filesystem::simple_memory_fs::SimpleMemoryFileSystem;
use crate::pr_info;
use crate::virtual_fs::dev::makedev;
use crate::virtual_fs::device_number::{blkdev_major, chrdev_major};
use crate::virtual_fs::{FileMode, FsError, MOUNT_TABLE, MountFlags, vfs_lookup};

// pub fn init_ext4() -> Result<(), crate::virtual_fs::FsError> {
//     unimplemented!()
// }
...
pub fn init_ext4_from_block_device() -> Result<(), crate::virtual_fs::FsError> {
...
pub fn init_procfs() -> Result<(), crate::virtual_fs::FsError> {
    use crate::filesystem::proc::ProcFS;
    use crate::virtual_fs::MountFlags;
...
/// 初始化并挂载 sysfs 到 /sys
pub fn init_sysfs() -> Result<(), crate::virtual_fs::FsError> {
    use crate::filesystem::sysfs::SysFS;
    use crate::virtual_fs::MountFlags;
