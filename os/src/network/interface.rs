...
use crate::device::network::network_device::NetDevice;
...
impl crate::device::Driver for NetworkInterface {
    ...
    fn as_net(&self) -> Option<&dyn crate::device::network::network_device::NetDevice> {
        Some(self.device.as_ref())
    }

    fn as_net_arc(self: Arc<Self>) -> Option<Arc<dyn crate::device::network::network_device::NetDevice>> {
