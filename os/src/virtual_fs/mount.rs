...
use crate::virtual_fs::{Dentry, FileSystem, FsError};
...
impl MountTable {
    ...
    pub fn mount(
        ...
        use crate::virtual_fs::normalize_path;
        ...
        if let Some(dentry) = crate::virtual_fs::DENTRY_CACHE.lookup(&normalized_path) {
            dentry.set_mount(&mount_point.root);
        }
