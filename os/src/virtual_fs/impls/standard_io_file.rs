...
use crate::{
    ...
    user_api::io_control::Termios,
    user_api::time::TimeSpec,
    virtual_fs::{File, FileMode, FsError, InodeMetadata, InodeType},
};
use alloc::sync::Arc;
...
/// 全局窗口大小（所有标准I/O文件共享）
static STDIO_WINSIZE: SpinLock<crate::user_api::io_control::WinSize> =
    SpinLock::new(crate::user_api::io_control::WinSize {
        ws_row: 24,
        ws_col: 80,
        ws_xpixel: 0,
        ws_ypixel: 0,
