...
use crate::virtual_fs::{File, FileMode, FsError, InodeMetadata, InodeType, OpenFlags, TimeSpec};
...
impl PipeFile {
    ...
    /// file_descriptor_table.install_at(3, Arc::new(pipe_read) as Arc<dyn File>)?;
    /// file_descriptor_table.install_at(4, Arc::new(pipe_write) as Arc<dyn File>)?;
    /// ```
