...
//! # 实现类型
//!
//! - [`RegFile`](crate::virtual_fs::RegFile) - 普通文件，基于 Inode，支持 seek
//! - [`PipeFile`](crate::virtual_fs::PipeFile) - 管道，环形缓冲区，流式设备
//! - [`StdinFile`](crate::virtual_fs::StdinFile) / [`StdoutFile`](crate::virtual_fs::StdoutFile) / [`StderrFile`](crate::virtual_fs::StderrFile) - 标准 I/O
...
//!
//! ```rust
//! use virtual_fs::{vfs_lookup, RegFile, OpenFlags, File};
//! use alloc::sync::Arc;
//!
//! // 1. 创建 File 对象
...
use crate::user_api::file_control::{OpenFlags, SeekWhence};
use crate::virtual_fs::{Dentry, FsError, Inode, InodeMetadata};
use alloc::sync::Arc;
